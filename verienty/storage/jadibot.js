...
conn.on('qr' ,async qr => {
  ...
  auth = true
        ...
        await fs.writeFileSync('./verienty/action/jadibot/jadibot.jpg', buff)
    let scen = await thunderx7.sendMessage(from, fs.readFileSync('./verienty/action/jadibot/jadibot.jpg'), MessageType.image, {quoted : thunder,caption: 'Scan QR ini untuk jadi bot sementara!\n1. Klik titik tiga di pojok kanan atas\n2. Ketuk WhatsApp Web\n3. Scan QR ini \n\nQR Expired dalam 20 detik'})
...
conn.on ('open',() => {
  ...
  fs.writeFileSync(`./verienty/action/jadibot/${sender}.json`, JSON.stringify(authInfo  ,null, '\t'))
})
